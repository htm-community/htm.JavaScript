...
ClassifierResult.prototype = {
     ...
     */
    copy: function() { // ClassifierResult<T>(void)
     ...
     * @return
     */
    getActualValue: function(bucketIndex) { // T(int)
     ...
     */
    getActualValues: function() { // T[](void)
     ...
     */
    setActualValues: function(values) { // void(T[])
     ...
     * @return
     */
    getActualValueCount: function() { // int(void)
     ...
     * @return
     */
    getStat: function(step, bucketIndex) { // double(int, int)
     ...
     * @param votes
     */
    setStats: function(step, votes) { // void(int, double[])
     ...
     * @return
     */
    getStats: function(step) { // double(int)
     ...
     * @return
     */
    getMostProbableValue: function(step) { // T(int)
        var idx = -1;
     ...
     */
    getMostProbableBucketIndex: function(step) { // int(int)
     ...
     * @return
     */
    getStepCount: function() { // int(void)
     ...
     * @return
     */
    getStatCount: function(step) { // int(int)
