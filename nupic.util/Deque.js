 ...
 */
Deque.prototype.append = function(t) { // boolean(t)
 ...
 * 				<em><b>prior</b></em> to this call.
 */
Deque.prototype.insert = function(t) { // boolean(t)
    var ret = this.currentSize === this.capacity;
    if (ret) {
 ...
 * 				is returned
 */
Deque.prototype.pushLast = function(t) { // E(E)
    var retVal = null;
 ...
 * 				is returned
 */
Deque.prototype.pushFirst = function(t) { // E(E)
    var retVal = null;
    var ret = currentSize === capacity;
    if (ret) {
 ...
 */
Deque.prototype.clear = function() { // void(void)
 ...
 * 			if it is empty.
 */
Deque.prototype.takeFirst = function() { // E(void)
    if (currentSize === 0) {
        return null;
    }
 ...
 * 			if it is empty.
 */
Deque.prototype.takeLast = function() { // E(void)
    if (currentSize === 0) {
        return null;
    }
 ...
 */
Deque.prototype.head = function() { // E(void)
    var val = null;
    try {
        val = this.backingList.takeFirst();
        this.currentSize--;
 ...
 * 			if it is empty.
 */
Deque.prototype.tail = function() { // E(void)
    var val = null;
    try {
        val = this.backingList.takeLast();
        this.currentSize--;
 ...
 * 				type &lt;T&gt;
 */
Deque.prototype.toArray = function(a) { // <T> T[](T[])
 ...
 * @return
 */
Deque.prototype.size = function() { // int(void)
 ...
 * @return
 */
Deque.prototype.capacity = function() { // int(void)
 ...
 */
Deque.prototype.resize = function(newCapacity) { // void(int)
 ...
 * @return
 */
Deque.prototype.peekFirst = function() { // E(void)
 ...
 * @return
 */
Deque.prototype.peekLast = function() { // E(void)
 ...
 * @return
 */
Deque.prototype.iterator = function() { // Iterator<E>(void)
 ...
 */
Deque.prototype.hashCode = function() { // int(void)
    var prime = 31;
    var result = 1;
 ...
 */
Deque.prototype.equals = function(obj) { // boolean(Object)
    if (this === obj) {
        return true;
    }
...
Deque.prototype.deepEquals = function(other) { // boolean(Deque<E>)
 ...
 * {@inheritDoc}
 */
Deque.prototype.toString = function() { // String(void)
